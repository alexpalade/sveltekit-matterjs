<script>
  ...
  onMount(async () => {
    ...
    //Trying Chiainign
    var boxes = Composites.stack(width / 2, height / 2, 1, 4, 0, 0.78, (x, y) =>
      Bodies.circle(x, y, 16, { dampening: 1 })
    );
